...
@Entity
@Table(name = "language_question_bengali", schema = "application")
public class LanguageQuestionBengaliEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "passage_id") private LanguagePassageBengaliEntity passage;
